...
const projects = [
  {
    projectTitle: "Bug_Bank",
    description:
      "an app to track what it is that I'm doing so that someone will know",
    contributors: "Jason Whisnant",
    id: uuidv4(),
    tickets: [
      {
        ...
        comments: [
          ...
          {
            comment:
              "It seems that the comments are working well in this system.",
            id: uuidv4(),
          ...
          {
            comment:
              "there are only five or six different issues on the system.",
            id: uuidv4(),
            author: "Santa Claus",
          ...
          {
            comment:
              "Going to consider a situation with a greater outcomes to the situation that we have to work with on this system.",
            id: uuidv4(),
            author: "Alan Turing",
            date: "March 4th, 2022",
          },
      ...
      },
      {
        ...
        comments: [
          {
            comment:
              "This is the first comment of the ticket 'more component pages?'",
            id: uuidv4(),
            author: "Ironhorse Johnson",
            date: "June 22nd, 2022",
          },
      ...
      },
      {
        ...
        comments: [
          {
            comment:
              "This is the first comment of the ticket 'styling questions'",
            id: uuidv4(),
            author: "Ironhorse Johnson",
            date: "June 22nd, 2022",
          },
  ...
  {
    projectTitle: "Blog",
    description: "Something to share my thoughts and ideas to the world with",
